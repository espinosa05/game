...
gcc -c time_test.c -I $CORE_INC_DIR -I $KIEK_INC_DIR
gcc time_test.o $CORE_OUT_DIR/libcore.a $KIEK_OUT_DIR/libkiek.a -o time_test -lvulkan -lxcb -lxcb-icccm -lxcb-keysyms
