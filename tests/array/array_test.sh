...
gcc -c array_test.c -I $CORE_INC_DIR -I $KIEK_INC_DIR $(pkg-config --cflags --libs libpipewire-0.3)
gcc array_test.o $CORE_OUT_DIR/libcore.a $KIEK_OUT_DIR/libkiek.a -o array_test -lvulkan -lxcb -lxcb-icccm -lxcb-keysyms -lpipewire-0.3 -lm
./array_test
