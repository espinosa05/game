...
gcc -c bm_font_test.c -I $CORE_INC_DIR -I $KIEK_INC_DIR
gcc bm_font_test.o $CORE_OUT_DIR/libcore.a $KIEK_OUT_DIR/libkiek.a -o bm_font_test -lvulkan -lxcb -lxcb-icccm -lxcb-keysyms
